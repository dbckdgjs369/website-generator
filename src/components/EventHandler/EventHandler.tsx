...
//     return Object.hasOwn(EventHandler.moduleList, name)
//       ? EventHandler.moduleList[name]
//       : null;
//   }
...
//       const module = (() => {
//         const module = EventHandler.find(name);
//         return module ? module : new EventHandler(name);
//       })();
//       module.setEvents(name, handler);
//     }
//   }
...
//       const module = EventHandler.find(name);
//       if (module) {
//         module.unsetEvents(name, handler);
